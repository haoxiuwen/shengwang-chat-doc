...
- VoIP 推送：CallKit 集成了 PushKit，你只需要在 IM SDK 初始化时设置 VoIP 推送证书，在 CallKit 初始化时启用 VoIP 功能。关于如何创建 VoIP 推送证书以及上传至 [声网控制台](https://console.shengwang.cn/overview)，详见 IM 的 [APNs 离线推送文档](/document/ios/push/push_apns.html)。
