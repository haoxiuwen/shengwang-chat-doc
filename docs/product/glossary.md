...
即时通讯 IM SDK 是环信提供的用于实现即时通讯，比如：单聊、群聊、聊天室的 SDK。

### 即时通讯 IMKit

IMKit 是即时通讯 IM SDK 的一个开源 UI 组件，提供应用内聊天的常用页面和 UI 组件，帮助开发者快速构建应用的 UI。
...
[环信通讯云控制台](https://console.easemob.com/user/login)是提供给开发者管理环信各项服务的工具。
