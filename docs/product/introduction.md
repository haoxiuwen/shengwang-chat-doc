...
你在声网控制台创建项目时需选择数据中心，你的业务数据会存在该数据中心。详见 [数据中心介绍文档](https://doc.easemob.com/product/data_center.html)。
...
环信控制台提供对即时通讯 IM 的管理功能。通过控制台，你可以开通即时通讯 IM 服务、购买增值服务、升级版本，进行消息推送、回调配置以及用户、群组、聊天室管理。
