...
| 名称                     | 用途                                                       |
| :----------------------- | :--------------------------------------------------------- |
| 国内 1 区、国内 2 区     | 即时通讯 IM 社区版、企业版、旗舰版、免费版和专业版客户所在集群。 |
...
在声网控制台创建项目时：
- 国内数据中心默认为 **国内 2 区**。若要使用其他数据中心，需要联系商务经理。
- 海外数据中心默认为 **新加坡 1 区**，也可选择 **美东1区** 或 **德国2区**。若要使用新加坡2区，需要联系商务经理。
...
环信控制台默认仅开放部分常用数据中心供选择。如果你需要使用其他数据中心，例如国内 VIP 区或其他海外集群，请联系商务经理申请开通。

### 2. 如何确认项目使用的数据中心？

你可以登录声网控制台，在 **应用概览** 页面查看应用所在数据中心及对应服务器域名。

### 3. 国内 1 区和国内 2 区有什么区别？

国内 1 区和国内 2 区在服务能力上没有区别。要使用国内 1 区需联系商务经理申请开通。
...
海外加速节点默认带宽为 **1 Mbps**。如果业务流量更高，可以根据实际需求配置更高带宽，具体请联系商务经理。
