<script setup>
  ...
  watch(pageData, ()=> {
    ...
    const isSdkDocPath =
      (
        pagePath.indexOf('/docs/document/') == 0 ||
        pagePath.indexOf('/docs/v4/') == 0 ||
        pagePath.indexOf('/docs/sdk/') == 0 ||
        pagePath.indexOf('/document/') == 0 ||
        pagePath.indexOf('/v4/') == 0 ||
        pagePath.indexOf('/sdk/') == 0
      ) &&
      pagePath.indexOf('/docs/document/server-side/') < 0 &&
    ...
    showCallKitSwitch.value = pagePath.indexOf('/callkit/') == 0 || pagePath.indexOf('/docs/callkit/') == 0

    if(pagePath.indexOf('/product/') == 0 || pagePath.indexOf('/docs/product/') == 0) title.value = ''
    else if(pagePath.indexOf('/uikit/') == 0 || pagePath.indexOf('/docs/uikit/') == 0) title.value = 'UIKit'
    else if(pagePath.indexOf('/callkit/') == 0 || pagePath.indexOf('/docs/callkit/') == 0) title.value = 'CallKit'
    else if(pagePath.indexOf('/document/server-side/') == 0 || pagePath.indexOf('/docs/document/server-side/') == 0) title.value = ''
      else if(
        pagePath.indexOf('/docs/document/') == 0 ||
        pagePath.indexOf('/docs/v4/') == 0 ||
        pagePath.indexOf('/docs/sdk/') == 0 ||
    ...
    else if(pagePath.indexOf('/value-added/') == 0 || pagePath.indexOf('/docs/value-added/') == 0) title.value = ''
