...
为方便用户在聊天过程中对文字消息进行翻译，即时通讯 IM SDK 集成了 Microsoft Azure Translation API，支持在发送或接收消息时对 **文本消息** 进行按需翻译或自动翻译：
...
1. 完成 `3.9.1 或以上版本` SDK 初始化，详见 [快速开始](/document/android/quickstart.html)。
