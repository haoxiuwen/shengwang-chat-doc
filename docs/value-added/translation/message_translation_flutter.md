...
为方便用户在聊天过程中对文字消息进行翻译，即时通讯 im_flutter_sdk 集成了 Microsoft Azure Translation API，支持在发送或接收消息时对 **文本消息** 进行按需翻译或自动翻译：
...
文本翻译为增值服务，如需使用请先在 [声网控制台](https://console.shengwang.cn/overview) 的 **套餐包 > 预付费套餐包 > 即时通讯 IM** 页面开通。
...
1. 完成 `1.0.5 或以上版本` SDK 初始化，详见 [快速开始](/document/flutter/quickstart.html)。
