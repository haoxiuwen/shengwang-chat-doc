...
3、IM 服务端请求，补充OPPO配置channelId的传值。
...
2、IM 服务端请求，补充小米配置 channelId的传值。
...
2、IM 服务端请求，补充 vivo 配置 category 传值。
...
3、IM 服务端请求，补充honor 配置 importance 传值。
