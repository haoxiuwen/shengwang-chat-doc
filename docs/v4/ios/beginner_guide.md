...
| [导入 SDK](/document/ios/integration.html)          | 将 SDK [集成到你的项目](/v4/ios/integration.html)中。 |
...
| [登录 IM](/document/ios/login.html)       | 使用创建的用户 [登录 IM](/document/ios/login.html#登录)。登录成功后，你可以使用 IM 的功能。 |
