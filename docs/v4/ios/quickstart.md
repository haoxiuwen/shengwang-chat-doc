...
1. 打开 [SDK 下载页面](https://www.easemob.com/download/im#IOS)，获取最新版的即时通讯 IM SDK，然后解压。
...
利用创建的用户名和密码登录即时通讯 IM，向对端用户发送消息。在下面示例中，向 user 2 发送文本消息。
