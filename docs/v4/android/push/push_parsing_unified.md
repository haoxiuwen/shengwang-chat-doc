...
如果 MainActivity 是启动页，建议采用 Activity 这种通用方式在点击通知栏后统一获取消息。如果 MainActivity 不是启动页，需要指定跳转到MainActivity 在点击通知栏后统一获取消息。
...
- [Android 解析消息示例](/v4/android/push/push_parsing.html)
