...
:::tip
 ...
 4. 消息附件流量大小的限制，详见 [消息限制说明](limitation.html#消息存储)。
:::
...
即时通讯 IM Android SDK 提供 [EMStatisticsManager](https://sdkdocs.easemob.com/apidoc/android/chat3.0/classcom_1_1hyphenate_1_1chat_1_1_e_m_statistics_manager.html) 类支持获取本地消息的流量统计信息，包含如下主要方法：
