...
| [初始化 SDK](/document/harmonyos/initialization.html)         | 使用 IM 的各项功能前，必须先初始化。传入你应用的 App ID 进行 [初始化](/document/harmonyos/initialization.html)。 初始化时，可配置自动登录、加群、退群推送等重要特性。|
