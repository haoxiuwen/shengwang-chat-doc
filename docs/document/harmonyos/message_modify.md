...
即时通讯 IM 通过 [ChatManager](https://sdkdocs.easemob.com/apidoc/harmony/chat3.0/classes/ChatManager.ChatManager.html) 和 [ChatMessageListener](https://sdkdocs.easemob.com/apidoc/harmony/chat3.0/interfaces/ChatMessageListener.ChatMessageListener.html) 实现消息编辑。
