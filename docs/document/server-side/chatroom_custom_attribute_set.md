...
| `username` | String | 是       | 用户 ID。设置该用户的聊天室自定义属性。 |
...
curl -X PUT 'https://XXXX/app-id/{app_id}/metadata/chatroom/662XXXX13/user/user1'    \
...
| - `errorKeys`   | Object | 设置失败的聊天室属性，返回键值对格式，key 为属性名称，value 为失败原因。 |
