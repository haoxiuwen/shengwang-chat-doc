...
```http
DELETE https://{host}/app-id/{app_id}/chatgroups/{group_id}/users/{members}?need_notify=false
```
...
curl -X DELETE 'https://XXXX/app-id/{app_id}/chatgroups/66XXXX85/users/ttXXXX81,user2,user3?need_notify=false'  \
