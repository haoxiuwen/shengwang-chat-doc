...
curl -X GET https://XXXX/app-id/{app_id}/chatgroups/10XXXX85/users?pagesize=1000&pagenum=1&joined_time=true'  \
...
| - `member`  | String | 群组管理员和普通成员的用户 ID。例如：{"member": "user3"}。   |
| - `joined_time` | String | 加入群组的时间。 |
