...
```http
POST https://{host}/app-id/{app_id}/chatgroups/{group_id}/users?need_notify=false
```
...
curl -X POST 'https://XXXX/app-id/{app_id}/chatgroups/66XXXX85/users?need_notify=false'   \
