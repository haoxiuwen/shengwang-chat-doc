...
```http
DELETE https://{host}/app-id/{app_id}/moderation/text/list/(list_id)/word?wordId={word_id}
```
...
curl -X DELETE 'https://XXXX/app-id/{app_id}/moderation/text/list/{list_id}/word?wordId={word_id}' \
