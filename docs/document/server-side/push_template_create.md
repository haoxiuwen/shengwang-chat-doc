...
创建离线推送消息模板，包括默认模板 **default**、**detail** 和自定义模板。你可以通过 [声网控制台](https://console.shengwang.cn/overview) 创建推送模板，详见 [推送模板配置文档](/document/android/push/push_template.html#开通功能)。
