...
- 关键词名单也可在 [环信控制台](https://console.easemob.com/user/login) 修改：选择 **即时通讯** > **内容审核** > **文本审核** > **关键词名单**。
...
```http
PUT https://{host}/app-id/{app_id}/moderation/text/list/{list_id}
```
...
curl -X PUT 'https://XXXX/app-id/{app_id}/moderation/text/list/1xXXXXVlodF52URYQk7rZmd5s8k' \
